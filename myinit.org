...
#+BEGIN_SRC emacs-lisp
  ...
  (defun load-leuven ()
    ...
    (disable-all-themes)
    (load-theme 'leuven t))
  (define-key load-light-theme (kbd "l") 'load-leuven)
  ...
  (define-key load-light-theme (kbd "p") 'load-plan9)
  ...
  (define-key load-light-theme (kbd "s") 'load-solarized-light)
  ...
  (define-key load-light-theme (kbd "t") 'load-twilight-bright)

  ;; Medium Themes

  (defun load-ample-light ()
    "Load the ample-light theme"
    (interactive)
    (disable-all-themes)
    (load-theme 'ample-light t))
  (define-key load-medium-theme (kbd "a") 'load-ample-light)
  ...
  (defun load-faff ()
    ...
    (disable-all-themes)
    (load-theme 'faff t))
  (define-key load-medium-theme (kbd "f") 'load-faff)

  (defun load-anti-zenburn ()
    "Load the anti-zenburn theme"
    (interactive)
    (disable-all-themes)
    (load-theme 'anti-zenburn t))
  (define-key load-medium-theme (kbd "z") 'load-anti-zenburn)

  ;; Dark Themes

  (defun load-challenger-deep ()
    "Load the challenger-deep theme"
    (interactive)
    (disable-all-themes)
    (load-theme 'challenger-deep t))
  (define-key load-dark-theme (kbd "c") 'load-challenger-deep)

  (defun load-base16-dracula ()
    "Load the base16-dracula theme"
    (interactive)
    (disable-all-themes)
    (load-theme 'base16-dracula t))
  (define-key load-dark-theme (kbd "d") 'load-base16-dracula)
  ...
  (define-key load-dark-theme (kbd "s") 'load-solarized-dark)
  ...
  (define-key load-dark-theme (kbd "z") 'load-zerodark)
#+END_SRC
* Set Fonts
#+BEGIN_SRC emacs-lisp
