...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key load-light-theme (kbd "l") (load-key-theme 'leuven))
  (define-key load-light-theme (kbd "p") (load-key-theme 'plan9))
  (define-key load-light-theme (kbd "s") (load-key-theme 'solarized-light))
  (define-key load-light-theme (kbd "t") (load-key-theme 'twilight-bright))
  ...
  (define-key load-medium-theme (kbd "a") (load-key-theme 'ample-light))
  (define-key load-medium-theme (kbd "f") (load-key-theme 'faff))
  (define-key load-medium-theme (kbd "z") (load-key-theme 'zenburn))
  ...
  (define-key load-dark-theme (kbd "c") (load-key-theme 'challenger-deep))
  (define-key load-dark-theme (kbd "d") (load-key-theme 'base16-dracula))
  (define-key load-dark-theme (kbd "s") (load-key-theme 'solarized-dark))
  (define-key load-dark-theme (kbd "z") (load-key-theme 'zerodark))
#+END_SRC
* Set Fonts
#+BEGIN_SRC emacs-lisp
