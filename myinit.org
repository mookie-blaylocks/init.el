...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key load-dark-theme (kbd "solarized-dark")
    '(lambda ()
       (interactive)
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key switch-font "a"
    '(lambda () (interactive) (set-font "Anonymous Pro 12")))
  (which-key-add-key-based-replacements "C-c f a" "Anonymous Pro")
  (define-key switch-font "i"
    '(lambda () (interactive) (set-font "Inconsolata 12")))
  (which-key-add-key-based-replacements "C-c f a" "Inconsolata")
  (define-key switch-font "s"
    '(lambda () (interactive) (set-font "Source Code Pro 12")))
  (which-key-add-key-based-replacements "C-c f a" "Source Code Pro")
  (define-key switch-font "t"
    '(lambda () (interactive) (set-font "Triplicate T4c 12")))
  (which-key-add-key-based-replacements "C-c f a" "Triplicate")
